...
import { V3HomeSections } from "@/components/motion-v3/V3HomeSections";
import { V3Root } from "@/components/motion-v3/V3Root";
import { BUSINESS } from "@/lib/business";
import "./v3.css";

/* ‏/v3 — ווריאנט "שמש ששוקעת לאורך הגלילה" (feat/home-v3-sun): שכבת שמש
   ורקע-יום על כל העמוד + שלושת אלמנטי /v2 מוגברים. עותק של /v2 — ‏/v2
   ו-/ לא נגועים.
   עותק 1:1 של עמוד הבית: ה-hero כאן, שאר המקטעים ב-V3HomeSections.
...
export default function HomeV3Sun() {
      ...
      >
        ...
        <Container className="relative z-[2] flex flex-col items-center gap-12 lg:flex-row lg:gap-[52px]">
          ...
          <div className="hero-img-in relative w-full lg:flex-[0.95]">
            ...
            <div className="v3-media-wrap h-[280px] w-full rounded-img shadow-[0_30px_60px_rgba(0,0,0,0.4)] md:h-[460px]">
              <video
                data-v3-video=""
