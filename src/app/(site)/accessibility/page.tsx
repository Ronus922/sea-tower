...
/* עמוד הצהרת נגישות — שלד 1:1 עם /terms (Hero + גל + TOC דביק + כרטיס
   ...
   אזורי המגע 44px ישב במקטע 4 עד שהפוטר ותוכן העניינים תוקנו (PR #42),
   ואז חזר למקטע 3. */
...
const DONE = [
  ...
  "אזורי מגע של 44 פיקסלים לפחות בכל הקישורים, כולל שורת הקישורים המשפטיים בתחתית העמוד ותוכן העניינים בעמודי המסמכים.",
];
