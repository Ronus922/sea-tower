        ...
        <div className="tk-grid">
          ...
          <div className="tk-pad" data-rev="card">
            ...
            <div id="s7" className="tk-sec">
              ...
              <p className="tk-clause">
                <strong>7.1.</strong> ניתן לבטל את ההזמנה בכל שלב, ללא דמי ביטול.</p>
              <p className="tk-clause">
                <strong>7.2.</strong> את הביטול ניתן לבצע באמצעות קטגוריית „תיק ההזמנות” באתר או בפנייה בכתב לכתובת: {BUSINESS.email}.</p>
              <p className="tk-clause">
                <strong>7.3.</strong> החברה אינה מחויבת לשמור על המחיר המקורי בעת שינוי הזמנה. במקרה של שינוי במחירים, יידרש המזמין להשלים את ההפרש.</p>
              <p className="tk-clause">
                <strong>7.4.</strong> הזמנה ששונתה פעם אחת – לא תוכל להשתנות שוב.</p>
              <p className="tk-clause">
                <strong>7.5.</strong> במקרה של אי הגעה (No-Show) ללא הודעת ביטול, תיחשב ההזמנה כמבוטלת ללא חיוב וללא דמי ביטול. נודה על הודעת ביטול מוקדמת ככל האפשר, כדי שנוכל להעמיד את הדירה לרשות אורחים אחרים.</p>
              <p className="tk-clause">
                <strong>7.6.</strong> בקשות ביטול או שינוי שיתקבלו ביום שבת או ביום מנוחה רשמי בישראל ייחשבו כאילו הוגשו ביום העבודה העוקב.</p>
              <p className="tk-clause">
                <strong>7.7.</strong> כל שינוי בהזמנה (לרבות: תאריכים, יעד, מספר נופשים וכדומה) עשוי להיות כרוך בתשלום דמי שינוי נוספים, בהתאם לתעריפים הנהוגים במועד ביצוע השינוי.</p>
              <p className="tk-clause">
                <strong>7.8.</strong> ביצוע שינויים יתאפשר באמצעות פנייה בכתב בלבד, בהתאם להוראות חוק הגנת הצרכן, התשמ״א-1981.</p>
              <p className="tk-clause">
                <strong>7.9.</strong> לחברה שמורה הזכות לאשר או לדחות בקשות שינוי, בכפוף להוראות הדין.</p>
            </div>
            <div id="s8" className="tk-sec">
              ...
              <p className="tk-clause">
                <strong>8.4.</strong> לאחר שעת הצ׳ק-אין לא תתאפשר קבלת האורח.</p>
              <p className="tk-clause">
            ...
            <div id="s21" className="tk-sec">
              ...
              {/* קישור הדדי לעמוד המלא — הסעיף כאן הוא תקציר בלבד (SEO-AUDIT A11) */}
              <p className="tk-clause" style={{ marginTop: "14px" }}>
                הרשימה המלאה של כללי האירוח מפורטת בעמוד{" "}
                <Link className="stm-link font-semibold text-ocean-400" href="/house-rules">
                  חוקי הבית
                </Link>
                .
              </p>
