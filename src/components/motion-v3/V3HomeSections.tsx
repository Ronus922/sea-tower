...
import { V3SectionHeading } from "@/components/motion-v3/V3SectionHeading";
import { StatCard } from "@/components/ui/StatCard";
import { IconTile } from "@/components/ui/IconTile";
import { CheckItem } from "@/components/ui/CheckItem";
import { V3RoomsCarousel } from "@/components/motion-v3/V3RoomsCarousel";
...
/* עותק /v2 של HomeSections (ניסוי התנועה, feat/home-motion): שני הבדלים
   מהמקור בלבד — V3SectionHeading (כותרות ל-GSAP במקום ws) ו-V3RoomsCarousel
...
export async function V3HomeSections() {
  ...
  return (
    <>
      ...
      <section id="about" className="bg-cloud py-14 md:py-[74px]">
        <Container className="flex flex-col items-center gap-12 lg:flex-row lg:gap-14">
          ...
          <div className="w-full lg:flex-[1.1]">
            ...
            />
            <p data-rev="up" className="v3-on-sky mt-5 text-body">
      ...
      <section id="apartments" className="bg-cloud py-14 md:py-20">
        <Container>
          <V3SectionHeading kicker="הדירות שלנו" title="סוויטות נבחרות מול הים" className="v3-on-sky mb-10" />
          {rooms.length > 0 ? (
            <V3RoomsCarousel rooms={rooms} />
          ) : (
      ...
      >
        ...
        <Container className="relative z-[2] flex flex-col items-center gap-12 lg:flex-row">
          <div className="v3-on-sky w-full text-white lg:flex-1">
            <V3SectionHeading dark kicker="בואו נתחיל" title={<>מתכננים הגעה <br />לחיפה?</>} />
            <p data-rev="up" className="v3-on-sky mt-4 mb-7 max-w-[440px] text-[17.5px] leading-[1.65] text-[#bcd4e6]">
