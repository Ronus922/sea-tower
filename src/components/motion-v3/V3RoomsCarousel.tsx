...
import { V3RoomCard } from "@/components/motion-v3/V3RoomCard";
import type { PublicRoom } from "@/lib/booking-api";

/* עותק /v2 של RoomsCarousel (ניסוי התנועה): משתמש ב-V3RoomCard, ומסמן את
   המיכל ב-data-v3-cards — טריגר יחיד לחשיפת הכרטיסים (V3Root, אלמנט 3).
   הקרוסלה אופקית ו-ScrollTrigger אנכי — לכן הטריגר על המיכל, לא פר-כרטיס */
...
export function V3RoomsCarousel({ rooms }: { rooms: PublicRoom[] }) {
  ...
  return (
    <div className="relative" data-v3-cards="">
