...
import { V2RoomCard } from "@/components/motion/V2RoomCard";
import type { PublicRoom } from "@/lib/booking-api";

/* עותק /v2 של RoomsCarousel (ניסוי התנועה): משתמש ב-V2RoomCard, ומסמן את
   המיכל ב-data-v2-cards — טריגר יחיד לחשיפת הכרטיסים (V2Root, אלמנט 3).
...
export function V2RoomsCarousel({ rooms }: { rooms: PublicRoom[] }) {
  ...
  return (
    <div className="relative" data-v2-cards="">
