...
/* עותק /v2 של RoomCard (ניסוי התנועה): בלי data-rev="card" של MotionEngine —
   חשיפת התמונה (clip-path + ‏scale) שייכת ל-GSAP ‏(V2Root, אלמנט 3) דרך
   מחלקת v2-room-media על עטיפת התמונה */
export function V2RoomCard({
  room,
  className,
  sizes,
  imagePriority = false,
  ...
  return (
    ...
    >
      <div className="v2-room-media relative h-[200px] w-full bg-chip md:h-[220px]">
        {cover && (
          <Image
            src={cover.src}
            alt={cover.alt}
