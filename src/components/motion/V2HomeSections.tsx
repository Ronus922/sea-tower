...
import { V2SectionHeading } from "@/components/motion/V2SectionHeading";
import { StatCard } from "@/components/ui/StatCard";
import { IconTile } from "@/components/ui/IconTile";
import { CheckItem } from "@/components/ui/CheckItem";
import { WaveSeparator } from "@/components/ui/WaveSeparator";
import { V2RoomsCarousel } from "@/components/motion/V2RoomsCarousel";
...
export async function V2HomeSections() {
  ...
  return (
    <>
      ...
      <section id="apartments" className="bg-cloud py-14 md:py-20">
        <Container>
          <V2SectionHeading kicker="הדירות שלנו" title="סוויטות נבחרות מול הים" className="mb-10" />
          {rooms.length > 0 ? (
            <V2RoomsCarousel rooms={rooms} />
          ) : (
      ...
      <section id="process" className="bg-white py-14 md:py-20">
        <Container className="flex flex-col gap-14 lg:flex-row">
          <div className="lg:flex-1">
            <V2SectionHeading kicker="פשוט להתארח" title={<>שלושה צעדים <br />עד הים</>} />
            {/* רצף אנכי 1→2→3 */}
          ...
          <div className="lg:flex-1">
            <V2SectionHeading kicker="שאלות נפוצות" title="כל מה שרציתם לדעת" />
      ...
      <section id="blog" className="bg-white py-14 md:py-20">
        <Container>
          <div className="mb-10 flex flex-wrap items-end justify-between gap-6">
            <V2SectionHeading kicker="מאמרים ותובנות" title="מהבלוג של מגדל הים" />
      ...
      >
        ...
        <Container className="relative z-[2] flex flex-col items-center gap-12 lg:flex-row">
          <div className="w-full text-white lg:flex-1">
            <V2SectionHeading dark kicker="בואו נתחיל" title={<>מתכננים הגעה <br />לחיפה?</>} />
