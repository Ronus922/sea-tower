...
| # | ממצא | פירוט |
|---|------|-------|
| B1 | ~~סתירת מדיניות ביטולים~~ **נפתר (2026-08-14, הכרעת בעלים):** הנוסח הקנוני היחיד בכל האתר — "ניתן לבטל את ההזמנה בכל שלב, ללא דמי ביטול." הופץ ל-stay-terms.ts (מקור יחיד), צ'קאאוט, FAQ, תקנון §7, פתרונות ו-meta של /booking. סעיפי הפרה/נזק במהלך שהות (8.5, 15.2, 20.3, house-rules) אינם מדיניות ביטול ונשארו. |
