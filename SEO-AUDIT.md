...
| # | ממצא | פירוט |
|---|------|-------|
| B1 | ~~סתירת מדיניות ביטולים~~ **סגור סופית (2026-08-15)** | הנוסח הקנוני היחיד בכל האתר — "ניתן לבטל את ההזמנה בכל שלב, ללא דמי ביטול." (מקור: stay-terms.ts). בסבב ההשלמה יושרו גם שני מופעי ה-No-Show: תקנון §7.5 (היה חיוב 100% על אי-הגעה → כעת ההזמנה נחשבת מבוטלת ללא חיוב) ופריט "אי-הופעה" ברשימת עילות האשראי-לביטחון ב-FAQ (הוסר). מופעים שנשארו במכוון כי אינם דמי ביטול: נזקים/פיקדון (תקנון 9.1, house-rules), הפרות במהלך שהות (8.5, 15.2, 20.3, קנס עישון 500₪, קנס רעש), "לבטלה ללא קנס" (5.2 — עקבי). |
| B2 | ~~דומיין בתקנון~~ **אודיט הושלם (2026-08-15), חסום חיצונית** | הקנוני המיועד `sea-tower.co.il` עדיין מצביע ב-DNS ל-35.246.215.141 (שרת האתר הישן, וורדפרס חי, תעודה שם עד 2026-10); הפרודקשן הזה הוא 51.195.82.57 ואין עליו תעודה לדומיין. כל ה-URL-ים המוחלטים בקוד נגזרים מ-`BUSINESS.siteUrl` היחיד — ההחלפה מוכנה כשינוי שורה אחת. **נדרש מהבעלים:** העברת A record של `sea-tower.co.il` + `www` ל-51.195.82.57; אז: certbot לדומיין, vhost, עדכון siteUrl, build+deploy, ו-301 מ-`sea-tower.bios.co.il`. אסור להחליף siteUrl לפני ה-DNS — קנוניקלים יצביעו לאתר זר. תקנון §1 כבר מפנה לדומיין הקנוני המיועד — נשאר. |
